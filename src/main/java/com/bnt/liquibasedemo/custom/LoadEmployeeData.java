...
public class LoadEmployeeData implements CustomTaskChange {
    ...
    public void execute(Database database) throws CustomChangeException {
        ...
        try {
            ...
            logger.info("Successfully inserted {} row(s) with JSON content from file: {}",
                    rowsAffected, skills);
    ...
    /**
     * Builds the SQL INSERT statement dynamically based on configured columns
     */
